function lightLabsWidget_jankilyInsertDiv() {
  const llwParentElem = document.querySelector(`h5[class="reassurances"]`);
  llwParentElem.insertAdjacentHTML(
    "afterend",
    `<div id="lightlabswidget"></div>`
  );
}
lightLabsWidget_jankilyInsertDiv();
const htmlToInject = `
