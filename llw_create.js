...
const labData = [
  {
    ...
    sidebarSectionsHtml: `
      ...
      <div class="lightlabswidget-sidebar-section">
          ...
          <div class="lightlabswidget-sidebar-section-text">
              A study showed a <strong>46% failure rate</strong> for creatine gummy brands comparing claimed vs. actual amounts of the active ingredient.
          </div>
          <div class="lightlabswidget-sidebar-section-text">
              Create has at least 100% of the active ingredient in every serving
          </div>
          <a href="https://www.nutritionaloutlook.com/view/now-tests-creatine-gummies-identifies-limitations-in-third-party-gummy-testing" target="_blank" class="lightlabswidget-sidebar-section-link">
